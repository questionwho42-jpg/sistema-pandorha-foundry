...
> _"A natureza não é cruel, apenas indiferente. Isso a torna muito mais perigosa."_
> — Kaelen, o Caçador

Este tomo detalha as ameaças naturais nativas de Pandorha. As fichas combinam narrativa imersiva com regras mecânicas rigorosas baseadas na _Matriz de Eixos_ e na _Economia de 3 Ações_.

---

## 1. Família Canina (Os Caçadores de Matilha)
...
- **Iniciativa:** +1 (Mental 1 + Inter 0) | **Sentidos:** Faro, Visão no Escuro (18m).
- **HP:** 15 | **CA:** 12 | **Movimento:** 12m.
- **Eixos:** Físico +2, Mental +1, Social 0.
- **Aplicações:** Conflito +1, Resistência +1, Interação 0.
- **Passiva - Tática de Matilha:** O lobo recebe **+2 nas jogadas de ataque** se um aliado dele estiver a 1,5m do alvo e não estiver incapacitado.
- **[A] Mordida na Jugular:** +3 (Nv 1 + Fis 2). Alcance 1,5m. Dano **1d6+2 Perfurante**. Se o alvo for uma criatura, deve ser bem sucedido em um **Teste Global de Físico + Resistência + Nível (DC 13)** (10 + Nv 1 + 2 Fis) ou ficará **Caído**.
...
- **Iniciativa:** +0 (Mental 1 + Inter -1) | **Sentidos:** Faro, Visão no Escuro (18m) | **Idioma:** Goblin.
- **HP:** 40 | **CA:** 14 (Pele Grossa) | **Movimento:** 15m.
- **Eixos:** Físico +4, Mental +1, Social 0.
- **Aplicações:** Conflito +3, Resistência +2, Interação -1.
- **Passiva - Faro de Sangue:** O Warg recebe **+2 em testes de Mental + Interação** (Rastreio) baseados em olfato.
- **[A] Estraçalhar:** +7 (Nv 3 + Fis 4). Alcance 1,5m. Dano **2d6+4 Perfurante**. Se o alvo estiver **Caído**, o ataque causa **+1d6 de dano**.
...
- **Iniciativa:** +3 (Mental 3 + Inter 0) | **Sentidos:** Visão Verdadeira (9m).
- **HP:** 55 | **CA:** 15 (Evasão Mágica) | **Movimento:** 12m (Teleporte).
- **Eixos:** Físico +3, Mental +3, Social +1.
- **Aplicações:** Conflito +2, Resistência +2, Interação 0.
- **Passiva - Forma Etérea:** O lobo pode gastar uma **Ação de Movimento** para entrar no Plano Etéreo até o início do seu próximo turno. Enquanto etéreo, ele tem **RD 5** a dano físico não-mágico e pode atravessar paredes.
- **[A] Mordida Espectral:** +7 (Nv 4 + Fis 3). Alcance 1,5m. Dano **2d6+3 Energia**. Este ataque atinge diretamente a alma: a Defesa do alvo é calculada usando **[Mental + Resistência]** em vez de CA física.

---

## 2. Família Goblinoide (A Praga Verde)
...
- **Iniciativa:** +3 (Mental 1 + Inter 2) | **Sentidos:** Visão no Escuro (18m) | **Idioma:** Goblin.
- **HP:** 10 | **CA:** 13 (Couro) | **Movimento:** 9m.
- **Eixos:** Físico +1, Mental +1, Social 0.
- **Aplicações:** Conflito +1, Resistência +1, Interação +2.
- **Passiva - Fuga Ágil:** O Goblin pode realizar a ação de **Desengajar** ou **Esconder-se** como uma Ação Livre no final de seu turno.
- **[A] Cimitarra Enferrujada:** +2 (Nv 1 + Fis 1). Alcance 1,5m. Dano **1d6+1 Cortante**. Se causar dano, alvo deve passar em **Teste Global de Físico + Resistência + Nível (DC 12)** (10 + Nv 1 + 1 Fis) ou contrai **Febre do Esgoto** (Condição: **Nauseado** por 1 hora, impedindo uso de Ações Múltiplas).
...
- **Iniciativa:** +6 (Mental 3 + Inter 3) | **Sentidos:** Percepção Mágica.
- **HP:** 18 | **CA:** 11 | **Movimento:** 9m.
- **Eixos:** Físico 0, Mental +3, Social +1.
- **Aplicações:** Conflito 0, Resistência +1, Interação +3.
- **Passiva - Líder Covarde:** Se um aliado morrer a 3m dele, o Xamã usa sua Reação para correr 9m na direção oposta ao perigo.
- **[AA] Raio de Fogo:** +5 (Nv 2 + Men 3). Alcance 18m. Dano **1d10 Fogo** + Condição **Em Chamas** (1d6/turno até apagar).
- **[A] Curar Aliado:** Toca um goblin e cura **1d8+3 HP**.
...
- **Iniciativa:** +5 (Mental 2 + Inter 3) | **Sentidos:** Visão no Escuro | **Idioma:** Goblin, Comum.
- **HP:** 45 | **CA:** 16 (Placas) | **Movimento:** 9m.
- **Eixos:** Físico +3, Mental +2, Social +2.
- **Aplicações:** Conflito +3, Resistência +2, Interação +3.
- **Passiva - Grito de Guerra:** Enquanto o Chefe estiver vivo e consciente, todos os Goblins a 9m ganham **+2 nas rolagens de Dano**.
- **[AA] Ataque Multiplo:** +7 (Nv 4 + Fis 3). Alcance 1,5m. Dois ataques. Dano **1d8+3 Cortante** cada.

---

## 3. Família Ursina (Reis da Floresta)
...
- **Iniciativa:** +1 (Mental 1 + Inter 0) | **Sentidos:** Faro (**+2 em Sentidos**).
- **HP:** 45 | **CA:** 13 (Natural) | **Movimento:** 12m.
- **Eixos:** Físico +4, Mental +1, Social 0.
- **Aplicações:** Conflito +3, Resistência +3, Interação 0.
- **[AA] Garra e Mordida:**
  1. **Garra:** +7 (Nv 3 + Fis 4). Alcance 1,5m. Dano **1d8+4 Cortante**.
  2. **Mordida:** +7. Alcance 1,5m. Dano **1d10+4 Perfurante**.

### B. Urso-Coruja (Nível 4)

**História:**
O resultado trágico de experimentos arcanos antigos que escaparam para a natureza. Combinando a visão noturna e o bico predador de uma coruja com a massa muscular e agressividade de um urso, eles dizimaram ecossistemas inteiros e agora reinam como superpredadores.
...
- **Iniciativa:** +2 (Mental 1 + Inter 1) | **Sentidos:** Visão no Escuro (24m).
- **HP:** 60 | **CA:** 14 (Penas e Couro) | **Movimento:** 12m.
- **Eixos:** Físico +5, Mental +1, Social 0.
- **Aplicações:** Conflito +4, Resistência +3, Interação +1.
- **Passiva - Visão no Escuro:** Enxerga na escuridão total.
- **[AA] Ataque Selvagem:** +9 (Nv 4 + Fis 5). Alcance 1,5m. Dois ataques de garras. Dano **2d8+5 Cortante** cada. Se ambos acertarem o mesmo alvo, a vítima deve passar em **Teste Global de Físico + Resistência + Nível (DC 19)** (10 + Nv 4 + 5 Fis) ou cairá **Caída**.
...
- **Iniciativa:** -1 (Mental 0 + Inter -1) | **Sentidos:** Visão Cega (Vibração) 18m.
- **HP:** 85 | **CA:** 15 (Natural) | **Movimento:** 12m.
- **Eixos:** Físico +6, Mental 0, Social -1.
- **Aplicações:** Conflito +5, Resistência +4, Interação -1.
- **Passiva - Imparável:** Imune à condição Caído ou Empurrado.
- **[A] Esmagar:** +11 (Nv 5 + Fis 6). Alcance 1,5m. Dano **3d8+6 Esmagamento**. Alvo fica **Agarrado** automaticamente (ver Condições).

---

## 4. Família Humana (Bandidos)
...
- **Iniciativa:** +2 (Mental 1 + Inter 1) | **Idioma:** Comum.
- **HP:** 12 | **CA:** 12 (Couro) | **Movimento:** 9m.
- **Eixos:** Físico +2, Mental +1, Social +1.
- **Aplicações:** Conflito +1, Resistência +1, Interação +1.
- **[A] Adaga Curta:** +3 (Nv 1 + Fis 2). Alcance 1,5m ou 6m. Dano **1d4+2 Perfurante**.
...
- **Iniciativa:** +3 (Mental 2 + Inter 1) | **Idioma:** Comum.
- **HP:** 15 | **CA:** 13 (Couro Batido) | **Movimento:** 9m.
- **Eixos:** Físico +2, Mental +2, Social 0.
- **Aplicações:** Conflito +1, Resistência +1, Interação +1.
- **[A] Besta Leve:** +4 (Nv 2 + Fis 2). Alcance 24m. Dano **1d8+2 Perfurante**.
...
- **Iniciativa:** +5 (Mental 2 + Inter 3) | **Idioma:** Comum, Ladrão.
- **HP:** 60 | **CA:** 16 (Cota de Malha) | **Movimento:** 9m.
- **Eixos:** Físico +3, Mental +2, Social +3.
- **Aplicações:** Conflito +3, Resistência +2, Interação +3.
- **Passiva - Aparar:** Como uma Reação, ele adiciona **+2 na CA** contra um ataque corpo a corpo que o atingiria.
- **[AA] Espada Larga:** +7 (Nv 4 + Fis 3). Alcance 1,5m. Dois ataques. Dano **1d10+3 Cortante** cada.

---

## 5. Família Peles-Verdes (Orcs)
...
- **Iniciativa:** +2 (Mental 0 + Inter 2) | **Sentidos:** Visão no Escuro | **Idioma:** Orc.
- **HP:** 35 | **CA:** 14 (Peles) | **Movimento:** 9m.
- **Eixos:** Físico +4, Mental 0, Social +1.
- **Aplicações:** Conflito +3, Resistência +3, Interação +2.
- **Passiva - Agressivo:** Pode usar **Ação Livre [F]** para se mover até sua velocidade em direção a um inimigo hostil (1x por turno).
- **[A] Machado Grande:** +7 (Nv 3 + Fis 4). Alcance 1,5m. Dano **1d12+4 Cortante**.
...
- **Iniciativa:** -1 (Mental -1 + Inter 0) | **Sentidos:** Visão no Escuro.
- **HP:** 50 | **CA:** 13 (Constituição) | **Movimento:** 12m.
- **Eixos:** Físico +5, Mental -1, Social +1.
- **Aplicações:** Conflito +5, Resistência +5, Interação 0.
- **Passiva - Imortalidade Temporária:** Se for reduzido a 0 HP, ele **não cai**. Continua lutando com 1 HP até o início do seu próximo turno.
- **[AA] Machadinhas Duplas:** +9 (Nv 4 + Fis 5). Alcance 1,5m. Dois ataques. Dano **1d6+5 Cortante**.
...
- **Iniciativa:** +7 (Mental 3 + Inter 4) | **Sentidos:** Visão Arcana.
- **HP:** 70 | **CA:** 16 (Cota de Anéis) | **Movimento:** 9m.
- **Eixos:** Físico +4, Mental +3, Social +2.
- **Aplicações:** Conflito +3, Resistência +3, Interação +4.
- **[A] Lança de Guerra:** +9 (Nv 5 + Fis 4). Alcance 3m. Dano **1d10+4 Perfurante**.
- **[A] Magia do Olho:** Pode lançar _Comando_ (Alvo faz **Teste Global de Mental + Resistência + Nível (DC 18)** (10 + Nv 5 + 3 Men) ou obedece) ou _Curar Ferimentos_ (2d8+3).

---

## 6. Família Kobold (Dracônicos)
...
- **Iniciativa:** +2 (Mental 1 + Inter 1).
- **HP:** 6 | **CA:** 12.
- **Eixos:** Físico +1, Mental +1, Social 0.
- **Aplicações:** Conflito 0, Resistência 0, Interação +2.
- **Passiva - Tática de Bando:** Recebe **+2 no Ataque** se tiver aliado adjacente ao alvo.
- **[A] Adaga:** +2 (Nv 1 + Fis 1). Dano **1d4+1 Perfurante**.
...
- **HP:** 15 | **CA:** 16 (Escudo).
- **Eixos:** Físico +2, Mental +1, Social +1.
- **Aplicações:** Conflito +1, Resistência +2, Interação +1.
- **Passiva - Proteger o Mestre:** Pode usar Reação para receber o dano no lugar de um aliado adjacente.
- **[A] Lança:** +4 (Nv 2 + Fis 2). Dano **1d6+2 Perfurante**.
...
- **Iniciativa:** +8 (Mental 4 + Inter 4).
- **HP:** 20 | **CA:** 12.
- **Eixos:** Físico +1, Mental +4, Social +1.
- **Aplicações:** Conflito -1, Resistência +1, Interação +4.
- **[A] Invenção Aleatória:** +5 (Nv 3 + Men 4 - Penalidade 2). Alcance 9m. Arremessa frascos ou insetos (Dano variado 2d6) que causam condições como **Em Chamas**.

---

## 7. Família Roedora (A Peste)
...
- **Iniciativa:** +0.
- **HP:** 8 | **CA:** 12.
- **Eixos:** Físico +1, Mental 0, Social 0.
- **Aplicações:** Conflito +1, Resistência +1, Interação 0.
- **[A] Mordida:** +2 (Nv 1 + Fis 1). Dano **1d4+1** + **Febre do Rato** (Alvo fica **Nauseado** por 1 hora se Teste Global de Físico + Resistência + Nível (DC 12) (10 + Nv 1 + 1 Fis) nega).
...
- **Iniciativa:** +2 (Instinto Coletivo).
- **HP:** 25 | **CA:** 10.
- **Eixos:** Físico +2, Mental -4, Social -4.
- **Aplicações:** Conflito +2, Resistência +2, Interação 0.
- **Passiva:** Resistente a ataques de alvo único. Ocupa espaço da vítima. O enxame age com instinto sobrenatural (+2 Iniciativa).
- **[A] Mordidas em Massa:** Ataque Automático (Sem rolagem). Qualquer criatura no espaço do enxame sofre **2d6 Perfurante** no início do turno do Enxame.
...
- **Iniciativa:** -2.
- **HP:** 30 | **CA:** 15.
- **Eixos:** Físico +3, Mental 0, Social -2.
- **Aplicações:** Conflito +3, Resistência +2, Interação -2.
- **[A] Cauda Lâmina:** +6 (Nv 3 + Fis 3). Dano **1d8+3 Cortante** + **Sangramento** (1d4/turno).

---

## 8. Família Rapina (Aves)
...
- **Iniciativa:** +2.
- **HP:** 25 | **CA:** 13.
- **Eixos:** Físico +3, Mental +1, Social +1.
- **Aplicações:** Conflito +2, Resistência +1, Interação +2.
- **[A] Garras:** +5 (Nv 2 + Fis 3). Dano **2d6+3 Cortante**.
...
- **Iniciativa:** +0.
- **HP:** 30 | **CA:** 14.
- **Eixos:** Físico +3, Mental 0, Social 0.
- **Aplicações:** Conflito +3, Resistência +1, Interação 0.
- **Passiva - Frenesi:** Se verem sangue, recebem **+2 no Ataque**.
- **[AA] Bicada:** +6 (Nv 3 + Fis 3).
...
- **Aplicações:** Conflito +4, Resistência +3, Interação +1.
- **[AA] Garras e Bico:** +10 (Nv 5 + Fis 5).

---

## 9. Família Porcina (Javalis)
...
- **Iniciativa:** -1.
- **HP:** 22 | **CA:** 11.
- **Eixos:** Físico +3, Mental 0, Social -1.
- **Aplicações:** Conflito +2, Resistência +3, Interação -1.
- **[A] Presas:** +5 (Nv 2 + Fis 3). Dano **1d6+3** + Se mover 6m (+1d6).
...
- **[A] Carga de Trovão:** +6. Dano **1d8+3** + **1d6 Elétrico**.
...
- **Iniciativa:** -1.
- **HP:** 55 | **CA:** 14.
- **Eixos:** Físico +5, Mental 0, Social -1.
- **Aplicações:** Conflito +4, Resistência +5, Interação -1.
- **[A] Atropelar:** +9 (Nv 4 + Fis 5). Dano **2d6+5** + **Teste Global de Físico + Resistência + Nível (DC 19)** (10 + Nv 4 + 5 Fis) ou cairá **Caído**.

---

## 10. Família Ofídica (Cobras)
...
- **Eixos:** Físico +3, Mental 0, Social 0.
- **Aplicações:** Conflito +3, Resistência +2, Interação 0.
- **[A] Constrição:** +5. Dano **1d8+3** + Condição **Agarrado**.
...
- **Aplicações:** Conflito +2, Resistência +1, Interação +1.
- **[A] Cuspe de Veneno:** +6. Dano **2d6 Veneno** + Condição **Cego** (**Teste Global de Físico + Resistência + Nível (DC 16)** (10 + Nv 3 + 3 Fis) nega).
...
- **Aplicações:** Conflito +3, Resistência +4, Interação +1.
- **Passiva - Olhar:** Quem olhar faz **Teste Global de Físico + Resistência + Nível (DC 19)** (10 + Nv 5 + 4 Fis) ou fica Lento.
- **[A] Mordida:** +9. Dano **2d6+4**.
