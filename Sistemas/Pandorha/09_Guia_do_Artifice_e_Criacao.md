...
Todo projeto de criação exige um1. **Possuir o Item Base:** Deve ser de qualidade Superior. 2. **Possuir o Reagente Arcano:** Relacionado ao encantamento (ex: Essência de Fogo para uma espada flamejante). 3. **Realizar o Ritual:** Teste de **Mental + Ocultismo + Nível (DC 15 + Nível do Item)**.

- **Ferramentas:** É obrigatório ter acesso a um laboratório, forja ou kit apropriado. Sem ferramentas, o teste é impossível.

| Nível do Item | DC Base                | Tempo (Dias) |
| :------------ | :--------------------- | :----------- |
| Comum         | **10 + Proficiência**  | 1            |
| Incomum       | **15 + Proficiência**  | 3            |
| Raro          | **20 + Nível do Item** | 7            |
| Épico         | **25 + Nível do Item** | 14           |
| Lendário      | **30 + Nível do Item** | 30           |

#### Tipos de Poções (Criação DC 15 + Nível do Item)

- **Poção de Cura (Menor):** Recupera **2d4+2 HP**. (**Custo:** 50 moedas).
- **Veneno Básico:** O alvo deve passar em **Teste Global de Físico + Resistência + Nível (DC 15)** ou sofrer **1d6 Veneno**. (**Custo:** 100 moedas).
- **Óleo de Afiar:** +1 no dano por 1 hora. (**Custo:** 150 moedas).
- **Poção de Cura (Maior):** Recupera **4d4+4 HP**. (**Custo:** 200 moedas). (**DC 20 + Nível**).
- **Veneno Mortal:** O alvo deve passar em **Teste Global de Físico + Resistência + Nível (DC 25)** ou sofrer **4d6 Veneno** e ficar **Envenenado**. (**Custo:** 500 moedas). (**DC 25 + Nível**).
...
| **Engenharia Arcana** | Varinhas, Cajados, Orbes e Pergaminhos. |
...
## ⚔️ 2. Engenharia de Armas (Exige: Forja de Guerra)
...
| **Defeito: Lenta**  | +1 (Ganha Ponto) | Ação de Recarga necessária.                                          |
...
| **Arcana (Azul)**   | Ruínas, Torres de Magos, Linhas de Ley.  | **Mental + Resistência + Nível (DC 10 + Tier)** | Cristal de Mana, Pó de Fada, Ectoplasma.          |
...
| **Aprendiz**  | **Fogo Líquido**        | 2x Mineral + 1x Arcana               |   14    | Granada. 3d6 Fogo em área (3m).                                                                                          |
| **Aprendiz**  | **Pele de Árvore**      | 2x Vital + 1x Mineral                |   15    | A pele fica dura como carvalho. +2 na CA por 1 hora.                                                                     |
| **Aprendiz**  | **Veneno Paralisante**  | 2x Vital + 1x Sombria                |   16    | Aplica na arma. Alvo deve passar em **Teste Global de Físico + Resistência + Nível (CD 16)** ou fica Imobilizado.        |
| **Aprendiz**  | **Gás do Sono**         | 2x Vital + 1x Arcana                 |   16    | Quebrar frasco. Nuvem de 3m. Quem respirar dorme por 1 minuto.                                                           |
|  **Mestre**   | **Invisibilidade**      | 2x Arcana + 1x Sombria               |   18    | Invisível por 1 hora ou até atacar.                                                                                      |
|  **Mestre**   | **Voo**                 | 3x Arcana + 1x Vital                 |   18    | Ganha Deslocamento de Voo (9m) por 10 min.                                                                               |
|  **Mestre**   | **Elixir da Verdade**   | 3x Arcana + 1x Sombria               |   20    | Alvo não consegue mentir deliberadamente por 10 minutos (**Teste Global de Mental + Resistência + Nível (CD 20)** nega). |
...
| Arcano/Eldritch                          | **Teste Global (DC 25 + Nível)** | Sangue de Deus, Coração de Titã   |
...
- **Falha Crítica (margem > 5 do DC):** **Ressonância Arcana.** A energia explode violentamente. O artífice sofre o dano listado acima.
...
## 📜 6. Manufatura de Itens Arcanos (Exige: Engenharia Arcana)

### 6.1 A Engenharia do Foco Arcano

Cajados e Varinhas não são madeira morta. Eles possuem um "Núcleo" (Core) que dita seu comportamento.

#### Passo 1: O Chassi (Corpo)

Crie o item físico usando as regras de Crafting normais (madeira, metal, osso).

- **Cajado (1d6, Versátil):** Base sólida.
- **Varinha (Canalizador):** Madeira leve e condutiva.

#### Passo 2: O Núcleo (Core)

O mago deve inserir um núcleo no item. O núcleo define a "personalidade" da magia canalizada.

- **Núcleo de Cristal (Quartzo):** Magias de Dano causam +1 de dano.
- **Núcleo Orgânico (Raiz/Osso):** Magias de Cura/Necromancia curam/causam +1.
- **Núcleo Metálico (Ouro):** Aumenta a duração de magias de buff em 1 Rodada.

#### Passo 3: O Despertar (Sintonização Real)

O item está pronto, mas dorme. Para acordá-lo, o mago deve realizar um ritual de 8 horas.

- **Custo de Sacrifício:** O mago deve sacrificar 5 Pontos de Energia Arcana (EA) PERMANENTEMENTE por 1 semana. Durante essa semana, ele tem menos energia, mas o cajado absorve isso para "ligar".
- **Resultado:** O item torna-se vinculado à alma do mago. Se outro tentar usar, a DC das magias cai em -2.

### 6.2 Orbes: A Mente Externa

Orbes são diferentes. Eles não canalizam; eles armazenam.

- **Criação:** Exige lapidação de gema bruta (Rubi, Safira, Esmeralda). Valor da gema bruta deve ser > 100 Ouro.
- **Memória:** Um Orbe pode "aprender" uma magia que o dono conhece. O dono gasta 1 semana meditando com o orbe. Depois disso, o Orbe pode conjurar essa magia 1x/Dia sem gastar os slots do dono.
- **Limite:** Um Orbe só segura 1 magia. Se quiser trocar, precisa limpar a memória (1 dia) e ensinar a nova (1 semana).

---

## 🛡️ 7. Criação de Armaduras (Exige: Forja de Guerra)
