...
## 🏗️ 1. A Tabela Mestra (Matemática por Nível)
...
## 🎲 1.5 O Padrão de Testes (Eixo + Aplicação)
...
- **Exemplos de Padrão:**
  ...
  - _Medo/Controle:_ **Mental + Resistência** (Vontade para negar).
  - _Explosões/Áreas:_ **Físico + Interação (Reflexos)** (Esquiva para metade).
  - _Ilusões:_ **Mental + Interação (Percepção)** (Ver a verdade).

---

## 🎨 2. Papéis Táticos (Ajustes de Template)
...
- **Sugestão de Passiva:** _Fortitude_ (RD 2 ou Imune a Derrubada).
...
## 🧮 3. A Matemática dos Eixos e Aplicações
