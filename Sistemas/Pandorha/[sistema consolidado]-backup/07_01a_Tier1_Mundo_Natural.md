...
- **Passiva - Forma Etérea:** O lobo pode gastar **1 Ação [A]** para entrar no Plano Etéreo até o início do seu próximo turno. Enquanto etéreo, ele tem **RD 5** a dano físico não-mágico e pode atravessar paredes.
- **[A] Mordida Espectral:** +7 (Nv 4 + Fis 3). Alcance 1,5m. **Vantagem no Ataque**. Dano **2d6+3 Energia**. Este ataque "pisca" entre as realidades, sendo extremamente difícil de aparar ou evitar, embora armaduras pesadas ainda ofereçam proteção aos órgãos vitais.
...
- **Passiva - Fuga Ágil:** O Goblin pode realizar a ação de **Desengajar** ou **Esconder-se** como uma 1 Ação [L] no final de seu turno.
...
- **Passiva - Agressivo:** Pode usar **1 Ação [F]** para se mover até sua velocidade em direção a um inimigo hostil (1x por turno).
...
- **Iniciativa:** +7 (Mental 3 + Inter 4) | **Sentidos:** Visão Etérica.
...
- **[A] Mordidas Coletivas:** Qualquer criatura que termine o seu turno no espaço ocupado pelo enxame deve fazer um **Teste Global de Físico + Conflito + Nível (DC 14)** (10 + Nv 1 + 3 Fis).
  - **Falha:** Sofre **1d6+1 Dano de Perfuração**.
  - **Sucesso:** Consegue afastar os ratos ou saltar para fora do caminho, não sofrendo dano.
