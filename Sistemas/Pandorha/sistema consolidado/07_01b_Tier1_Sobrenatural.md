...
- **Eixos:** Físico +3, Mental +1, Social 0.
- **Aplicações:** Conflito +3, Resistência +2, Interação 0.
- **[A] Garra Paralisante:** +6 (Nv 3 + Fis 3). Dano **2d4+3**. Se o alvo for uma criatura viva (não elfo), deve passar em **Teste Global de Físico + Resistência + Nível (DC 16)** (10 + Nv 3 + 3 Fis) ou ficar **Imobilizado/Paralisado** por 1 minuto.
...
- **[A] Pó Mágico:** Alcance 3m. Alvo faz **Teste Global de Mental + Resistência + Nível (DC 14)** (10 + Nv 1 + 3 Men/Soc) ou cai no **Sono** (Inconsciente por 1 minuto ou até sofrer dano) ou **Levita** (Involuntariamente, 6m no ar).
