...
(async () => {
    ...
    function openClassSelector(actor, item) {
        ...
        classData.talentos.forEach((t, i) => {
            talentosHTML += `
            <div style="margin: 4px 0; padding: 8px; border: 1px solid #c5a55a; border-radius: 4px; background: #fdf8ef;">
                <label style="display: flex; align-items: flex-start; gap: 6px; cursor: pointer;">
                    ...
                    <div>
                        <strong style="color: #2a1a0a;">${t.n}</strong><br/>
                        <small style="color: #4a3a2a;">${t.d}</small>
                    </div>
                </label>
            </div>`;
        });
        ...
        <form>
            ...
            <p style="font-style: italic; color: #4a3a2a; text-align: center; margin: 8px 0;">
                ${classData.descricao}
            </p>

            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin: 10px 0;">
                <div style="padding: 8px; background: #f5e6c8; border: 1px solid #c5a55a; border-radius: 4px; color: #3a2a1a;">
            ...
            <p style="color: #8b6914; text-align: center; font-size: 0.85em; font-weight: bold;">
